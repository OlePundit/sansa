...
@section('content')
<div id="app" style="background-image:url({{url("/storage/about.png")}});background-repeat: no-repeat;  background-size: cover;height:100vh" >
    ...
    <div class="row justify-content-center">
        ...
        <div class="row section-info" id="section-info">
            <div class="col-lg-6 col-md-12 col-sm-12">
                <img src="/storage/person.png" class="person">
            </div>
            <div class="col-lg-6 col-md-12 col-sm-12">
            ...
            <div class="row d-flex align-items-center justify-content-center">
                <div class="col-sm-12 d-flex align-items-center justify-content-center" style="margin-top:200px;">
                    <div class="rectangle d-flex align-items-center justify-content-center" style="overflow: visible;padding: 16px;">
                        <img src="/storage/hand.png" width="636px" height="636px" class="pt-5" style="margin-left:0px;">
