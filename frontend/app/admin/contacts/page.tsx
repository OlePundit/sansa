          ...
          {lastPage > 1 && (
            <div className="flex justify-between items-center mt-6">
              <button
                ...
                className="px-4 py-2 text-sm border border-gray-500 text-gray-500 rounded-md disabled:opacity-50 disabled:cursor-not-allowed cursor:hover-pointer hover:bg-gray-50"
              >
                Previous
              </button>
