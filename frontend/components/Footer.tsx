        ...
        <div className="flex flex-col lg:flex-row w-full justify-between lg:w-4/5 gap-10 lg:gap-20">
          ...
          <div className="flex flex-col">
            ...
            <ul className="flex flex-col gap-2">
              <li>
                <Link href="/" className="text-white hover:underline text-base lg:text-lg">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/#section-projects" className="text-white hover:underline text-base lg:text-lg">
                  Projects
                </Link>
              </li>
              <li>
                <Link href="/#section-prices" className="text-white hover:underline text-base lg:text-lg">
                  Packages
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-white hover:underline text-base lg:text-lg">
                  Contact
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-white hover:underline text-base lg:text-lg">
                  About
                </Link>
              </li>
              <li>
                <Link href="/blogs" className="text-white hover:underline text-base lg:text-lg">
                  Blog
                </Link>
              </li>
            </ul>
          ...
          <div className="flex flex-col">
            ...
            <ul className="flex flex-col gap-2 text-base lg:text-lg">
              <li>
                <Link href="mailto:info@sansadigital.com" className="flex items-center gap-2">
                  <Mail className="w-6 h-6" /> info@sansadigital.com
                </Link>
              </li>
              <li>
                <Link href="https://wa.me/+254112128055" className="flex items-center gap-2">
              ...
              <li>
                <Link href="tel:+254112128055" className="flex items-center gap-2">
