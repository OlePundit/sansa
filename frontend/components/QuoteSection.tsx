...
export default function QuoteSection() {
  return (
    <section className="flex flex-col items-center justify-center w-full py-10 sm:py-16">
      ...
      <div className="absolute inset-0 bg-[url('/storage/texture.jpg')] bg-cover bg-no-repeat opacity-30 pointer-events-none rounded-[32px]"></div>
        ...
        <div className="relative z-20 flex flex-col items-center justify-center text-center max-w-[600px]">
          <h3 className="text-3xl md:text-4xl text-[#193155] font-bold mb-4">
            Request Quote
          </h3>
          ...
          <Link
            href="/contact"
            className="text-[#2c96e2] text-[24px] cursor-pointer font-semibold bg-white rounded-lg py-2 px-6 transition-all duration-300 hover:bg-[#2f976b] hover:text-white"
          >
            Contact
          </Link>
        </div>
